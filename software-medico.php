...
<body>
    ...
    <section class="header_tittle">
        	...
        	<div id="banner_software-medico">
				<div class="row wow fadeInDown">
                    <div class="container">
                        <div class="col-lg-12 col-sm-12 col-md-12">
    					<h2 style="padding-top:80px"> &copy;  SM Software Medico 2015</h2>
    					<p>Instalable en Equipos <B>Windows XP, Vista, 7 , 8 , 10 o MAC OS</B></p>
						<p>Dirigido a Especialistas, Grupos Médicos o Clinicas</p>
	...
	<div class="container" >
		<div class="row" >
	        ...
	        <div class="col-lg-6 col-sm-12  col-xs-12" align="justify">
				...
				<p><b> &copy;  SM Software Médico 2015:</b> Es un Software de Historias Medicas  es un sistema dirigido a agilizar y resguardar la información de pacientes, historias médicas, administración de ingresos y egresos, impresion de documentos. Es un software seguro y confiable.</p>
					
				<p>Este sistema está diseñado para la consultas de un especialista, Grupos y Centros Médicos. Es fácil de usar, intuitivo y con el entrenamiento que usted necesita para optimizar su consulta.
				</p>
			...
			<div class="col-lg-12 col-sm-12  col-xs-12">
				...
				<p><b>- Consultas e Historias:</b> Permite guardar Antecendentes Personales y Familiares, Evolucion, Tratamientos Realizados, Consultas del Paciente. </p>
				...
				<p><b>- Imagenología: </b>Permite guardar imagenes Individuales de cada paciente de cada uno de ellos.</p>
				...
				<p><b>- Identificación de Documentos:</b> Identificacion de Documentos con sus respectivos datos m&eacute;dicos y logos personalizables.</p>
	...
	<div class="row" >
        ...
        <div class="col-lg-6 col-sm-12  col-xs-12 center">
            ...
            <div class="col-lg-6 col-sm-12  col-xs-12 center">
            	<a href="tutoriales.php#tab1" class="btn-lg btn-success"> Videotutoriales</a>
            </div>
            <br/>
        </div>
