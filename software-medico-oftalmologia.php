...
<body>
    ...
    <section class="header_tittle">
			...
			<div id="banner_software-medico-oftalmologia">
				<div class="row wow fadeInDown">
                    <div class="container">
                        <div class="col-lg-12 col-sm-12 col-md-12">
    					<h2 style="padding-top:80px"> &copy; SM Software M&eacute;dico Oftalmolog&iacute;a 2015</h2>
	...
	<div class="container" >
		...
		<h2>Descripción del Sistema</h2>
			...
			<p><b> &copy; SM Software de Historias Oftalmologicas 2015:</b> es un sistema dirigido a agilizar y resguardar la información de pacientes, historias médicas,administración de ingresos y egresos, impresion de documentos. Es un software seguro y confiable.</p>
			
			<p>Este sistema está diseñado para la consultas de un especialista, Grupos Médicos y Centros Oftalmologicos.Es fácil de usar, intuitivo y con el entrenamiento que usted necesita para optimizar su consulta.
			</p>
			...
			<p>El sistema contiene modulos relacionados con cada una de las acciones realizadas en la consulta.</p>
				...
				<p><b>- Imagenología: </b>Permite guardar imagenes Individuales de cada paciente y de los Fondos de Ojo de cada uno de ellos.</p>
	...
	<div class="row" >
        ...
        <div class="col-lg-6 col-sm-12  col-xs-12 center">
            ...
            <div class="col-lg-6 col-sm-12  col-xs-12 center">
            	<a href="tutoriales.php#tab5" class="btn-lg btn-success"> Videotutoriales</a>
            </div>
            <br/>
        </div>
