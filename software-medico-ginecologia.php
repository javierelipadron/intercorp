...
<body>
    ...
    <section class="header_tittle">
        	...
        	<div id="banner_software-medico-ginecologia">
				<div class="center wow fadeInDown">
					<h2 style="padding-top:80px">Software Medico Ginecología</h2>
					
					<p>Instalable en Equipos Windows XP, Vista, 7 , 8 o MAC</p>
	...
	<h2>Descripción del Sistema</h2>
			...
			<p>Software de Historias Ginecologicas es un sistema dirigido a agilizar y resguardar la información de pacientes, historias médicas y hacer de la administración de cada consulta una tarea más fácil de llevar.</p>
			
<p>Este sistema está diseñado para la consultas de un especialista, Grupos Médicos, Centros Odontologicos. Fácil de usar, intuitivo y con el entrenamiento que usted necesita para optimizar su consulta.
</p>
	...
	<p>El sistema contiene modulos relacionados con cada una de las acciones realizadas en la consulta.</p>
		...
		<p><b>- Consultas e Historias Médicas:</b> Permite guardar Antecendentes Personales y Familiares, Evolucion del Paciente, Tratamientos Realizados, Consultas Ginecologicas y Obstetricas de I-II y III Trimestre. </p>
		<p><b>- Colposcopias: </b>Permite guardar Odontodiagramas individuales de cada paciente.</p>
		...
		<p><b>-  Documentos Impresos:</b> Permite crear e imprimir tus propias plantillas imprimir y modificar Documentos, Presupuestos, Recipes, Constancias Médicas, Solicitudes de Examenes con la identificación,Consultas Ginecologicas y Obstetricas de I-II y III Trimestre.</p>	
	...
	<h2>Tipos de Licencias:</h2>
		...
		<div class="col-sm-4" style="background:#0099FF; min-height:50px; text-align:center; color:#000"> <b>Grupo Médico</b><br/> (2 a 20 especialistas): - 1 o mas Secretarias </div>
